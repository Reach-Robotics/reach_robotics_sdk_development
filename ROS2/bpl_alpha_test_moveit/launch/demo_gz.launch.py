...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("alpha_5", package_name="bpl_alpha_test_moveit")
    ...
    default_world = os.path.join(
        get_package_share_directory('bpl_alpha_test'),
        'worlds',
        'empty.world'
        )    
    ...
    rviz_config_path = os.path.join(
        get_package_share_directory("bpl_alpha_test_moveit"),
        "config",
        "moveit.rviz",
    )
    ...
    bridge_params = os.path.join(get_package_share_directory('bpl_alpha_test'),'config','bridge_params.yaml')
    ros_gz_bridge = Node(
